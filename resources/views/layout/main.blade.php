...
<head>
    ...
    <!--// Meta tag Keywords -->
    <!-- css files -->
    <link href="{{asset('dist/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" /> <!-- Bootstrap-Core-CSS -->
    <link href="{{asset('dist/css/style.css')}}" rel="stylesheet" type="text/css" media="all" /> <!-- Style-CSS -->
    <link rel="stylesheet" href="{{asset('dist/css/font-awesome.css')}}"> <!-- Font-Awesome-Icons-CSS -->
    <link href="{{asset('dist/css/pogo-slider.min.css')}}" rel="stylesheet" type="text/css" media="all" /> <!-- Banner-Slider-CSS -->
    <link href="{{asset('dist/css/nav.css')}}" rel="stylesheet" type="text/css" media="all" /> <!-- Nav-CSS -->
    <link rel="stylesheet" href="{{asset('dist/css/owl.carousel.css')}}" type="text/css" media="all"/> <!-- Owl-Carousel-CSS -->
    <link href="{{asset('dist/css/lsb.css')}}" rel="stylesheet" type="text/css"> <!-- gallery-css -->
    <!-- //css files -->
    <!-- online-fonts -->
    ...
    <!-- //online-fonts -->
    <!-- js files -->
    <script src="{{asset('dist/s/modernizr.js')}}j"></script>
    <!-- /js files -->
</head>
<body>
...
<section class="banner-w3ls">
    <div class="banner-w3l-mk">
        <div class="logo-w3ls">
            <a href="#"><h1><i class="fa fa-gratipay" aria-hidden="true"></i>Handout</h1></a>
        </div>
        <div class="w3_agileits_header_text">
            <h3>Donate<i class="fa fa-bank" aria-hidden="true"></i></h3>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Handout</h4>
                </div>
...
@yield('value')
    ...
    <script type="text/javascript" src="{{asset('dist/js/bootstrap.js')}}"></script> <!-- Necessary-JavaScript-File-For-Bootstrap -->
    <!-- //js -->
    <!-- js for banner -->
    ...
    <!-- /js for navigation -->
    <!-- Gallery -->
    <script src="{{asset('dist/js/lsb.min.js')}}"></script>
    <script>
    ...
    <!-- //Gallery -->
    <!-- Numscroller -->
    <script type="text/javascript" src="{{asset('dist/js/numscroller-1.0.js')}}"></script>
    <!-- //Numscroller -->
